...
function startGifPreview(i) {
  gifPreviewTimeout = setTimeout(() => showFullscreenStory(i), 300);
}
function endGifPreview() {
  clearTimeout(gifPreviewTimeout);
}
...
async function loadExamples() {
  ...
  list.innerHTML = "";
  try {
    const r = await fetch("https://your-server.amvera.tech/examples");  // <-- тут поставь свой домен
